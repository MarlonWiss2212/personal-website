...
export default function Projects() {
  ...
  const projects: ProjectType[] = [
    { title: t("zewothermApp.title"), message: t("zewothermApp.message"), images: ["/react-native.png", "/expo.png"], className: "", appStoreLink: "https://apps.apple.com/de/app/zewotherm-produktwelt/id1659347270", playStoreLink: "https://play.google.com/store/apps/details?id=de.zwsystems.produktwelt" },
    {
  ...
  return (
    <div className="flex flex-col gap-10 overscroll-none w-full h-full md:px-10 lg:pb-14">
      ...
      <div className="flex flex-col flex-grow overflow-y-scroll">
        <div className="grid grid-flow-dense grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4 lg:pb-14">
