...
import { AcademicCapIcon, ArchiveBoxIcon, Bars3Icon, CodeBracketSquareIcon, DocumentTextIcon, FolderIcon, HomeIcon, RectangleStackIcon, XMarkIcon } from '@heroicons/react/24/outline'
import './globals.css'
